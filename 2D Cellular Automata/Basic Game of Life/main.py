...
def make_png(screen, num):
    num += 1
    dirvid = '/Users/jstinson/Desktop/2D Cellular Automata/Basic Game of Life/Images'
    fullpath = dirvid + "//" + "%08d.png"%num
    pygame.image.save(screen, fullpath)
    return num

def make_mp4():
    vid_output = '//Users//jstinson//Desktop//2D Cellular Automata/Basic Game of Life//Videos//CA ' + str(datetime.now()) + '.mp4'
    os.system("ffmpeg -r 1 -i '//Users//jstinson//Desktop//2D Cellular Automata/Basic Game of Life//Images//%08d.png' -vcodec mpeg4 -q:v 0 -y '{}'".format(vid_output))
